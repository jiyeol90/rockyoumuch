...
<html>
   ...
   <?php
      ...
      */ 
      ...
      $sql="select * from phptest.concert where visible = 'y' and $find like '%$search%' order by num desc";
      } else {
      $sql="select * from phptest.concert where visible = 'y' order by num desc";
      }
      try{  
      $stmh = $pdo->query($sql); 
      ...
      if(!$search){
        $sql = "select * from phptest.concert where visible = 'y' order by num desc limit $start_num , $list ";
      } else {
        $sql="select * from phptest.concert where visible = 'y' and $find like '%$search%' order by num desc limit $start_num , $list ";
      }
      $stmh = $pdo->query($sql);  
